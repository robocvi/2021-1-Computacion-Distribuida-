import simpy
from Canales import CanalBroadcastFlodding
from Nodo import *
...
if __name__ == "__main__":
    ...
    bc_pipe = CanalBroadcastFlodding.CanalBroadcastFlodding(envi)
    ...
    for i in range(0, len(adyacencias)):
        envi.process(grafica[i].construir_arbol(envi))
    envi.run()